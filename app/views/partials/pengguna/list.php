                                                ...
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td class="td-user_role_id">
                                                        <span <?php if($can_edit){ ?> data-source='<?php print_link('api/json/pengguna_user_role_id_option_list'); ?>' 
                                                            ...
                                                            data-showbuttons="left" 
                                                            class="is-editable" <?php } ?>>
                                                            <?php echo $data['role_name'] ?? $data['user_role_id']; ?> 
                                                        </span>
                                                    </td>
                                                    <th class="td-btn">
                                                        <?php if($can_view){ ?>
                                                        <a class="btn btn-sm btn-outline-success has-tooltip" title="View Record" href="<?php print_link("pengguna/view/$rec_id"); ?>">
                                                            <i class="fa fa-eye"></i>
                                                        </a>
                                                        <?php } ?>
                                                        <?php if($can_edit){ ?>
                                                        <a class="btn btn-sm btn-outline-info has-tooltip" title="Edit This Record" href="<?php print_link("pengguna/edit/$rec_id"); ?>">
                                                            <i class="fa fa-edit"></i>
                                                        </a>
                                                        <?php } ?>
                                                        <?php if($can_delete){ ?>
                                                        <a class="btn btn-sm btn-outline-danger has-tooltip record-delete-btn" title="Delete this record" href="<?php print_link("pengguna/delete/$rec_id/?csrf_token=$csrf_token&redirect=$current_page"); ?>" data-prompt-msg="Are you sure you want to delete this record?" data-display-style="modal">
